export default defineEventHandler((event) => {
    return [
        ...
        // }
        {
            title: 'Garas Management System',
            live: '',
            github: '',
            thumbnail: 'https://i.imgur.com/VzSgWo2h.png',
            description: 'This project was created using vue and meteor on my last semester as my final year project',
            tech: ['vue','meteor','quasar']
        }
    ]
  });
